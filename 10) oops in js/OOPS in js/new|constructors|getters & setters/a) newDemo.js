...
class Product {
  ...
  `this` keyword is actually pointing to the `brand new plain empty object` created using new keyword.
  ...
  */
  ...
  constructor(n, p, d) {
    ...
    */
    ...
    - return "Vaibhav" -> Nothing will happen same answer will come out.
